...
//        http://47.104.227.113:8080/?mod=sendPay&act=sp&uid=8246539&jfd=2&amount=6&server=1
        URIBuilder uri=new URIBuilder("http://47.104.227.113:8080").setParameter("mod","sendPay")
                .setParameter("act","sp").setParameter("uid",rechargeOrder.getUid())
                .setParameter("jfd",order.getOrderIndex()+"").setParameter("amount",order.getAmount()+"")
                .setParameter("server",rechargeOrder.getServerId()+"");
