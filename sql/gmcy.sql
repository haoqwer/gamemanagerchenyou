...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户类(日报)';
...
CREATE TABLE `t_income_class` (
  ...
  PRIMARY KEY (`in_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='收入类(用户)';
...
CREATE TABLE `t_channel_count` (
  ...
  `count_time` datetime(6) NOT NULL COMMENT '创建时间',
...
CREATE TABLE `t_ltv_count` (
  ...
  `channel_id` int(11) DEFAULT NULL COMMENT '渠道id',
  PRIMARY KEY (`ltv_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='LTV概况';
...
CREATE TABLE `t_active_player` (
  ...
  `show_time` datetime(6) NOT NULL COMMENT '记录时间',
...
CREATE TABLE `t_retain_player` (
  ...
  `show_time` datetime(6) NOT NULL COMMENT '展示时间',
...
CREATE TABLE `t_login_day` (
  `count_day` int(11) NOT NULL AUTO_INCREMENT COMMENT '登录天数',
  `count_num` int(11) NOT NULL COMMENT '用户数量',
  `server_id` int(11) DEFAULT NULL,
  `channel_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`count_day`)
...
CREATE TABLE `t_onlineplayer_count` (
  ...
  `record_time` datetime(6) DEFAULT NULL COMMENT '记录年月日',
...
CREATE TABLE `t_everyday_recharge` (
  ...
  `recharge_first_user` int(11) DEFAULT NULL COMMENT '首冲人数',
  `recharge_count` int(11) DEFAULT NULL COMMENT '充值次数',
  `recharge_first_count` int(11) DEFAULT NULL COMMENT '首冲次数',
  `recharge_money` int(11) DEFAULT NULL COMMENT '充值金额',
  `recharge_first_money` int(11) DEFAULT NULL COMMENT '首冲金额',
...
CREATE TABLE `t_force_rank` (
  `force_id` int(11) NOT NULL COMMENT '排名',
...
CREATE TABLE `t_level_rank` (
  `level_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '排名',
  `player_name` varchar(16) NOT NULL COMMENT '玩家名',
...
CREATE TABLE `t_intimacy_rank` (
  `intimate_id` int(11) NOT NULL COMMENT '排名',
  `player_name` varchar(16) NOT NULL COMMENT '玩家名',
